...
def test_round3_summary_covers_frozen_five_and_valid_baseline() -> None:
    summary = _read_json(ROUND_DIR / "round-3-summary.json")
...
def test_round3_manifest_records_ready_environment_probe() -> None:
...
def test_round3_artifacts_do_not_expose_raw_windows_absolute_paths() -> None:
    manifest = _read_json(ROUND_DIR / "round-manifest.json")
    summary = _read_json(ROUND_DIR / "round-3-summary.json")
...
def test_round3_per_model_artifacts_exist_for_all_five() -> None:
