...
def test_rerun_summary_covers_frozen_five_and_is_valid_baseline() -> None:
...
def test_rerun_manifest_records_ready_environment_probe() -> None:
...
def test_rerun_artifacts_do_not_expose_raw_windows_absolute_paths() -> None:
    manifest = _read_json(ROUND_DIR / "round-manifest.json")
    summary = _read_json(ROUND_DIR / "round-1-summary.json")
